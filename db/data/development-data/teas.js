module.exports = [
...

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/2017_Kagoshima_sencha.jpg/1024px-2017_Kagoshima_sencha.jpg?20170624211809",
    origin: "Japan",
    type: "green",
    caffeine: "20-40mg",
    caffeineLevel: "low",
    description:
      "A Japanese green tea prepared by infusing whole tea leaves in hot water.",
    colorDescription: "light green",
    tasteDescription:
      "fresh, herbal, or grassy flavor, which can have varying vegetal grassy notes depending on how long it is steeped.",
...

  {
    ...
    altnames: "",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Matcha_Scoop.jpg/1024px-Matcha_Scoop.jpg?20190105233506",
    origin: "China",
    type: "green",
    caffeine: "20-90mg",
    caffeineLevel: "moderate",
    ...
    tasteDescription:
      "vegetal grassy notes, natural sweet nuttiness, a touch of bitterness with a pleasant savory ending",
...

  {
    ...
    altnames: "",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/d/dd/Shizuoka_bancha.jpg",
    origin: "Japan",
    type: "green",
    caffeine: "~10mg",
    caffeineLevel: "very low",
    description:
      "Tea that is harvested from the same tea tree as sencha grade, but it is plucked later than sencha is. Can be found in a number of forms such as roasted, unroasted, smoked, etc.",
    colorDescription: "light green to green-orange",
    tasteDescription:
      "mild, earthy grassiness, with dry, toasty notes with less of a deeply vegetal, umami flavo",
...

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Gyokuro_img_0067.jpg/480px-Gyokuro_img_0067.jpg",
    origin: "Japan",
    type: "green",
    caffeine: "~35mg",
    caffeineLevel: "low",
    description:
      "A type of shaded green tea from Japan. It differs from the standard sencha (a classic unshaded green tea) in being grown under the shade rather than the full sun.",
    colorDescription: "ranging from light green to dark green",
    tasteDescription:
      "very full-bodied, with a taste reminiscent to seaweed and grasses, followed by an intense sweetness",
...

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Kukicha.jpg/480px-Kukicha.jpg",
    origin: "Japan",
    type: "green",
    caffeine: "1-5mg",
    caffeineLevel: "very low",
    description:
      "A Japanese blend made of stems, stalks, and twigs. It is available as a green tea or in more oxidised processing",
...

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Konacha.jpg/640px-Konacha.jpg",
    origin: "Japan",
    type: "green",
    caffeine: "based on plant growth",
    caffeineLevel: "varied",
    description:
      "A type of green tea, composed of the dust, tea buds and small leaves that are left behind after processing Gyokuro or Sencha",
...

  {
    ...
    altnames: "",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Houjicha.jpg/360px-Houjicha.jpg",
    origin: "Kyoto, Japan",
    type: "green",
    caffeine: "5-10mg",
    caffeineLevel: "very low",
    description:
      "A Japanese green tea that is roasted in a porcelain pot over charcoal",
    colorDescription: "distinctive clear red appearance",
    tasteDescription:
      "naturally sweet taste and smoky flavor with distinct notes of cocoa",
    sources: "https://en.wikipedia.org/wiki/H%C5%8Djicha",
  },

  {
    ...
    altnames: "",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/2/29/Da_Hong_Pao_Oolong_tea_leaf.jpg",
    origin: "China",
    type: "oolong",
    caffeine: "20-30mg",
    caffeineLevel: "moderate",
    description:
      "A Wuyi rock tea grown in the Wuyi Mountains of Fujian Province, China",
    colorDescription: "orange-yellow, bright and clear",
    tasteDescription:
      "peaty and earthy notes with hints of stone fruit, brown sugar, and molasses",
...

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/b/b0/Shui_Jin_Gui_Oolong_tea_leaf.jpg",
    origin: "China",
    type: "oolong",
    caffeine: "20-30mg",
    caffeineLevel: "moderate",
...

  {
    ...
    caffeineLevel: "moderate",
    description:
      "Grown on the cliffs of the Wuyi Mountains in China, Tieluohan is a light tea with high regards due to legends",
...

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Bai_Jiguan.jpg/600px-Bai_Jiguan.jpg",
    origin: "China",
    type: "oolong",
    caffeine: "20-30mg",
    caffeineLevel: "moderate",
    ...
    tasteDescription:
      "starts off sweet, uniquely fruity with a toasty floral honeyed aroma and finishes with a lingering mellow fruit and honey note",
...

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/Shui_Xian.jpg/600px-Shui_Xian.jpg",
    origin: "China",
    type: "oolong",
    caffeine: "10-20mg",
    caffeineLevel: "low",
    ...
    colorDescription: "Deep amber",
    tasteDescription:
      "Mellow and delicate, the liquid is rich and complicated, with lingering fragrance in mouth",
...

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Tieguanyin2.jpg/640px-Tieguanyin2.jpg",
    origin: "China",
    type: "oolong",
    caffeine: "12-14mg",
    caffeineLevel: "low",
    description:
      "A variety of oolong tea that was originated during the 19th century",
    colorDescription: "bright emerald to bright yellow",
    tasteDescription:
      "roasted, nutty, creamy, fruity, toasty, honey, floral, fresh, vegetal and mineral",
    sources: "https://en.wikipedia.org/wiki/Tieguanyin",
  },

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/1/13/Huang_Jin_Gui_Tea.jpeg/640px-Huang_Jin_Gui_Tea.jpeg",
    origin: "China",
    type: "oolong",
    caffeine: "0",
    caffeineLevel: "none",
    description:
      "A premium variety of Chinese oolong tea named after the yellow golden color of its budding leaves and its unique flowery aroma",
    colorDescription: "light yellow to light green",
    tasteDescription:
      "smooth sweet flavor with a rich slightly nutty after-taste",
...

  {
    ...
    altnames: "Tung-ting",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Dong_Ding_tea.jpg/640px-Dong_Ding_tea.jpg",
    origin: "Taiwan",
    type: "oolong",
    caffeine: "50-60mg",
    caffeineLevel: "moderate",
    description:
      'An oolong tea from Taiwan which translates to "Frozen Summit" or "Icy Peak", and is the name of the mountain in Taiwan where the tea is cultivated',
    colorDescription: "dark, army-green color with slight hints of brown",
    tasteDescription:
      "Conatins nutty notes, along with a smooth caramel-like flavor",
...

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Dun-fan-mey-zhen-teashopby.jpg/640px-Dun-fan-mey-zhen-teashopby.jpg",
    origin: "Taiwan",
    type: "oolong",
    caffeine: "50-90mg",
    caffeineLevel: "high",
    description:
      "A heavily oxidized, non-roasted, tip-type oolong tea originating in Hsinchu County, Taiwan",
...

  {
    ...
    altnames: "Pouchong",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/Spring_pouchong_tea_leaves_on_plate.jpg/640px-Spring_pouchong_tea_leaves_on_plate.jpg",
    origin: "China",
    type: "oolong",
    caffeine: "20-30mg",
    caffeineLevel: "low",
    description:
      "A lightly oxidized tea, twist shape, with floral notes, and usually not roasted",
    colorDescription:
      "mix of pale honey yellow and jade green, bright in color, and clear",
    tasteDescription:
      "grassy, floral notes and the taste of creamy green melon.",
...

  {
    ...
    caffeineLevel: "high",
    description:
      'Ruan Zhi, or "soft stem", is a variety of oolong tea developed by the Taiwan Tea Experiment Station ',
...

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Jin_Xuan_oolong_tea.jpg/480px-Jin_Xuan_oolong_tea.jpg",
    origin: "Taiwan",
    type: "oolong",
    caffeine: "10-20mg",
    caffeineLevel: "low",
    ...
    tasteDescription:
      "taste is light, creamy, and flowery and sometimes compared to milk",
...

  {
    ...
    altnames: "",
    image:
      "https://tea-api-boonaki.herokuapp.com/assets/assam-smokedoolong.jpg",
    origin: "China",
    type: "oolong",
    caffeine: "NA",
    caffeineLevel: "none",
    description:
      "Assam Smoked Oolong is a highly unusual and rare oak smoked tea from Mothola Tea Estate in Assam. ",
    colorDescription: "amber red",
    tasteDescription:
      "oaky, smokey, sweet, malty, has notes of apricots and tobacco",
    sources: "",
  },

  {
    ...
    caffeineLevel: "very low",
    description:
      "A white tea made from only the top buds of the Camellia sinensis plant.",
...

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Baimudan.JPG/640px-Baimudan.JPG",
    origin: "China",
    type: "white",
    caffeine: "15-30mg",
    caffeineLevel: "low",
    description:
      "A type of white tea made from plucks each with one leaf shoot and two immediate young leaves (one bud two leaf ratio) of the Camellia sinensis plant.",
    colorDescription: "golden yellow",
    tasteDescription:
      " toasty, slightly sweet floral notes and a clean aftertaste.",
...

  {
    ...
    altnames: "Sow Mee",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Shou_Mei_tea.JPG/640px-Shou_Mei_tea.JPG",
    origin: "China",
    type: "white",
    caffeine: "15-30mg",
    caffeineLevel: "low",
    description:
      "A type of white tea produced from naturally withered upper leafs and tips",
...

  {
    ...
    tasteDescription:
      "smooth, juicy taste has clean notes of unripe fruits, light wood and just a touch of vegetal astringency.",
    sources: "",
  },

  {
    ...
    caffeineLevel: "moderate",
    description:
      "A white tea made from a blend of select Superior Cultivars from Malawi, making it rich in theanine and antioxidants.",
    colorDescription: "golden yellow",
    tasteDescription:
...

  {
    ...
    altnames: "",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/Earl_Grey_Tea.jpg/640px-Earl_Grey_Tea.jpg",
    origin: "UK*",
    type: "blend",
    caffeine: "40-120mg",
    caffeineLevel: "very high",
...

  {
    ...
    altnames: "",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/TwiningsLadyGrey_low.jpg/640px-TwiningsLadyGrey_low.jpg",
    origin: "UK*",
    type: "blend",
    caffeine: "25-110mg",
    caffeineLevel: "high",
...

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/English_breakfast_tea_tin.jpg/536px-English_breakfast_tea_tin.jpg",
    origin: "UK",
    type: "blend",
    caffeine: "60-100mg",
    caffeineLevel: "very high",
    ...
    description:
      "a traditional blend of black teas from Assam, Ceylon, Keemun and Kenyan teas.",
    colorDescription: "deep amber",
...

  {
    ...
    altnames: "",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Milk_in_Irish_Breakfast_tea.jpg/480px-Milk_in_Irish_Breakfast_tea.jpg",
    origin: "UK",
    type: "blend",
    caffeine: "60-100mg",
    caffeineLevel: "very high",
    mainIngredients: "black tea (varied)",
    description:
      "A traditional blend of black teas from Assam and Ceylon teas. Because of its strength, it is most commonly served with milk.",
...

  {
    ...
    altnames: "Spiced tea",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Contents_of_a_bag_of_chai_tea.jpg/640px-Contents_of_a_bag_of_chai_tea.jpg",
    origin: "India",
    type: "blend",
    caffeine: "40-50mg",
    caffeineLevel: "high",
    ...
    description:
      "An Indian tea beverage made by boiling black tea in milk and water with a mixture of aromatic herbs and spices",
...

  {
    ...
    description:
      "A chinese tea blended with various oolong and black teas that gets its name from tea trading through a traderoute that connected eastern Asia to Europe through Russia",
...

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/7/74/Genmaicha.JPG/640px-Genmaicha.JPG",
    origin: "Japan",
    type: "blend",
    caffeine: "10mg",
    caffeineLevel: "low",
    ...
    description:
      "A Japanese brown rice green tea consisting of green tea mixed with roasted popped brown rice.",
...

  {
    ...
    description:
      "Dragon Pearl Jasmine is comprised of little, hand-rolled pearls gently infused with jasmine flowers",
    colorDescription: "clear light yellow",
    tasteDescription:
      "Jasmine, root beer, sweet, but yet a light/subtle feeling.",
    sources: "",
  },
];
